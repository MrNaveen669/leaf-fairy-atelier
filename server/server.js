...
app.use('/api/collections', collections); app.use('/api/products', products); app.use('/api/projects', projects); app.use('/api/testimonials', testimonials); app.use('/api/enquiries', enquiries); app.use('/api/commerce', commerce);
