export const ASSET_BASE='https://raw.githubusercontent.com/MrNaveen669/leaf-fairy-atelier/main/src/assets';
export const heroImg=`${ASSET_BASE}/hero.jpg`;
export const stats=[
 {value:'12+',label:'Years composing interiors'},{value:'600+',label:'Spaces styled across India'},{value:'48',label:'Hospitality partners'},{value:'3 yr',label:'Colour-fastness guarantee'}
];
